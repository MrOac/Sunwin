...
namespace Configs {
    ...
    export class App {
        ...
        static API: string = "https://iportal.cb5chau.com/api";
		static API2: string = "https://iportal2.cb5chau.com/api";
		static APIROY: string = "https://portal.cb5chau.com/api";
        ...
        static LINK_GROUP = "https://www.facebook.com/DangCapSunWin";
        ...
        static readonly HOST_SOCKJS = "https://st.cb5chau.com/";
        ...
        static getLinkFanpage() {
            switch (VersionConfig.CPName) {
                default:
                    return "https://www.facebook.com/DangCapSunWin";
            }
        }
