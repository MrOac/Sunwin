...
export default class Loading extends cc.Component {
    ...
    listTips = [
        ...
        {
            vi: "KEMVIN nạp rút nhanh chóng và an toàn!",
            en: "KEMVIN quick cashin,cashout and alway safety!"
        },
    ]
    start() {
    ...
    startGame() {
        ...
        if (Configs.App.IS_LOCAL == false) {
            Http.get("https://cb5chau.com/assets/AssetBundleVersion.json", {}, (err, data) => {
    ...
    loadLobby() {
        ...
        BundleControl.loadBundle("Lobby", (bundle) => {
            ...
            bundle.loadScene('Lobby', function (finish, total, item) {
                self.lblStatus.string = "" + parseInt((finish / total) * 100) + "%";
