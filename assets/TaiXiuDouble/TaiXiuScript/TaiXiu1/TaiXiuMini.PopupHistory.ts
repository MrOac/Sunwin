...
namespace taixiumini {
    ...
    export class PopupHistory extends Dialog {
        ...
        setItemData(item, itemData) {
            ...
            item.getChildByName("lblBetDoor").getComponent(cc.Label).string = itemData["betSide"] == 1 ? App.instance.getTextLang('txt_taixiu_big1') :  App.instance.getTextLang('txt_taixiu_small1');
