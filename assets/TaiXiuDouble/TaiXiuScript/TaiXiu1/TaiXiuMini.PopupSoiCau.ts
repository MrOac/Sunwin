...
namespace taixiumini {
    ...
    export class PopupSoiCau extends Dialog {
        ...
        private drawPage1() {
            ...
            this.lblLastSession.string = App.instance.getTextLang('Phiên Gần Nhất') + "(#" + last.session + ") " + (lastScore >= 11 ? App.instance.getTextLang('Tài') : App.instance.getTextLang('Xỉu')) + "  " + lastScore + "(" + lastDices[0] + " - " + lastDices[1] + " - " + lastDices[2] + ")";
