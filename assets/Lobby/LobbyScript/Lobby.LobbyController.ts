...
namespace Lobby {
    ...
    export class LobbyController extends cc.Component {
        ...
        actOpenMessager() {
            cc.sys.openURL("https://t.me/Tonggiang1102");
        ...
        actOpenLive() {
            App.instance.openWebView("https://t.me/Tonggiang1102");
        }

        actOpenHotLine() {
            if (cc.sys.isNative) {
                cc.sys.openURL("tel: 0383276666");
            }
            else {
                App.instance.alertDialog.showMsg("Hotline : 0383,27,6666");
            }
        }
        ...
        actSupportOnline() {
            ...
            if (!cc.sys.isNative) {
                var url = "https://t.me/Tonggiang1102";
                cc.sys.openURL(url);
                //Tawk_API.toggle();
            }
            else {
