...
export default class App extends cc.Component {
    ...
    static DOMAIN = "cb5chau.com";
    static API_CMD: string = "https://ga.cb5chau.com/3rd/cmd";
    static API_IBC: string = "https://ga.cb5chau.com/3rd/ibc";
    static API_SBO: string = "https://ga.cb5chau.com/3rd/sbo"
    static API_AG: string = "https://ga.cb5chau.com/3rd/ag";
    static API_EBET: string = "https://ga.cb5chau.com/3rd/ebet";
    static API_WM: string = "https://ga.cb5chau.com/3rd/wm";

    //http://localhost:8081/api?c=2021&nn=tuanbigbird&at=1628224022&ip=127.0.0.1&mn=100
    updateConfigGame(domain = "cb5chau.com") {
